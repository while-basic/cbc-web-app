...
This is the core system prompt template for the Christopher Celaya conversational interface.

## Usage

This prompt should be combined with the knowledgebase from `@knowledgebase/christopher_celaya_knowledge_base.json`.

**Implementation Pattern:**
```typescript
import KNOWLEDGE_BASE from '@knowledgebase/christopher_celaya_knowledge_base.json';
...
**Note:** The knowledgebase is loaded from `@knowledgebase/christopher_celaya_knowledge_base.json`. This contains comprehensive information about:
- Bio & background
- Active projects (CLOS, Neural Child, Cognitive Artifacts/ACP, C-Cell Music)
- Philosophy & approach
- Celaya Solutions
- Expertise & skills
- Cognitive patterns
- Research interests
- Mental artifacts & coined terms
- Communication style
...
The knowledgebase at `@knowledgebase/christopher_celaya_knowledge_base.json` should be:
1. Imported/loaded at application startup
2. Injected into the system prompt template at the `KNOWLEDGE CONTEXT` section
3. Updated whenever new information is added to the knowledgebase directory structure

See `@knowledgebase/README.md` for information on how to update the knowledgebase.
